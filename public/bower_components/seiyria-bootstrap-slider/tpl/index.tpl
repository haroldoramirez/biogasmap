...
#ex1Slider .slider-selection {
	background: #BABABA;
      	...
      	<div id="example-2" class='slider-example'>
      		...
      		<div class="well">
      			Filters by price interval: <b>€ 10</b> <input id="ex2" type="text" class="span2" value="" data-slider-min="10" data-slider-max="1000" data-slider-step="5" data-slider-value="[250,450]"/> <b>€ 1000</b>
      		</div>
<h5>HTML</h5>
<pre><code class="html">
Filters by price interval: &ltb&gt€ 10&lt/b&gt &ltinput id="ex2" type="text" class="span2" value="" data-slider-min="10" data-slider-max="1000" data-slider-step="5" data-slider-value="[250,450]"/&gt &ltb&gt€ 1000&lt/b&gt
</code></pre>
